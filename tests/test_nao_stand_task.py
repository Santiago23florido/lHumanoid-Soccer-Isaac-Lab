...
TASK = ROOT / "source" / "humanoid_soccer_lab" / "humanoid_soccer_lab" / "tasks" / "direct"
...
def test_both_task_variants_register() -> None:
    ...
    from humanoid_soccer_lab.tasks.direct.nao_stand import PLAY_TASK_ID, REGISTERED, TASK_ID
